...
MCCTC AV is a command-line antivirus scanner I built in Go for my **senior capstone project**. The goal was to go beyond just using security tools and actually understand how they work under the hood how does an antivirus engine decide if a file is malicious? How does it scan thousands of files efficiently? What are its weaknesses?
